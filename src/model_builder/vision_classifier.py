...
class VisionClassifier(L.LightningModule):
    def __init__(
        ...
        self.classification_head = ClassificationHead(
            input_dimensions=(vision_projection_dimension),
    ...
    def forward(self, images: torch.Tensor, tokens: BatchEncoding) -> torch.Tensor:
        ...
        :param tokens: Tokenized language inputs. Passing Tokens so that MultiModalDataset
        ...
        return self.classification_head(vision_features)
